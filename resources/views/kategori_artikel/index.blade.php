    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <td>
                    <a href="{!! route('kategori_artikel.index') !!}" class="btn btn-primary">Data Yang Tersimpan</a>
                    <a href="{!! route('kategori_artikel.trash') !!}" class="btn btn-danger">Data Yang Terhapus</a>
                    </td>
